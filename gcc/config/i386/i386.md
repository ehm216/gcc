...
;; All integer modes without DImode.
(define_mode_iterator SWI124M [QI HI (SI "TARGET_64BIT")])
...
(define_expand "movstrict<mode>"
  [(set (strict_low_part (match_operand:SWI124M 0 "nonimmediate_operand"))
	(match_operand:SWI124M 1 "<general_operand>"))]
  ""
{
...
(define_insn "*movstrict<mode>_1"
  [(set (strict_low_part
	  (match_operand:SWI124M 0 "nonimmediate_operand" "+<r>m,<r>"))
	(match_operand:SWI124M 1 "<general_operand>" "<r>n,m"))]
  "(!TARGET_PARTIAL_REG_STALL || optimize_function_for_size_p (cfun))
   && !(MEM_P (operands[0]) && MEM_P (operands[1]))"
...
(define_insn "*movstrict<mode>_xor"
  [(set (strict_low_part (match_operand:SWI124M 0 "register_operand" "+<r>"))
	(match_operand:SWI124M 1 "const0_operand"))
   (clobber (reg:CC FLAGS_REG))]
  "reload_completed"
  "xor{<imodesuffix>}\t%0, %0"
  [(set_attr "type" "alu1")
...
(define_insn_and_split "*zext<SWI124M:mode>_doubleword_and"
  [(set (match_operand:DWI 0 "register_operand" "=&<SWI124M:r>")
	(zero_extend:DWI (match_operand:SWI124M 1 "nonimmediate_operand" "<SWI124M:r>m")))]
  "TARGET_STV
   && TARGET_SSE2
...
{
  split_double_mode (<DWI:MODE>mode, &operands[0], 1, &operands[0],
		     &operands[2]);

  emit_move_insn (operands[0], const0_rtx);

  gcc_assert (!TARGET_PARTIAL_REG_STALL);
  emit_insn (gen_movstrict<SWI124M:mode>
	     (gen_lowpart (<SWI124M:MODE>mode, operands[0]),
			   operands[1]));
})

(define_insn_and_split "*zext<SWI124M:mode>_doubleword"
  ...
  "#"
  "&& reload_completed && GENERAL_REG_P (operands[0])"
  [(set (match_dup 0) (zero_extend:DWIH (match_dup 1)))
   (set (match_dup 2) (const_int 0))]
  "split_double_mode (<DWI:MODE>mode, &operands[0], 1, &operands[0],
		      &operands[2]);")
...
(define_insn_and_split "*zext<mode>_doubleword"
  [(set (match_operand:DWI 0 "register_operand" "=r")
	(zero_extend:DWI (match_operand:DWIH 1 "nonimmediate_operand" "rm")))]
...
(define_insn_and_split "*and<mode>3_doubleword"
  [(set (match_operand:DWI 0 "nonimmediate_operand" "=r,rm,r")
	(and:DWI
	 (match_operand:DWI 1 "nonimmediate_operand" "%0,0,0")
	 (match_operand:DWI 2 "x86_64_szext_general_operand" "Z,re,rm")))
   (clobber (reg:CC FLAGS_REG))]
  "TARGET_STV
   && TARGET_SSE2
  ...
  "&& reload_completed"
  [(parallel [(set (match_dup 0)
		   (and:DWIH (match_dup 1) (match_dup 2)))
	      (clobber (reg:CC FLAGS_REG))])
   (parallel [(set (match_dup 3)
		   (and:DWIH (match_dup 4) (match_dup 5)))
	      (clobber (reg:CC FLAGS_REG))])]
  "split_double_mode (<MODE>mode, &operands[0], 3, &operands[0],
		      &operands[3]);")
...

;; Logical AND, inclusive and exclusive OR instructions in TImode

(define_expand "<code>ti3"
  [(set (match_operand:TI 0 "nonimmediate_operand")
	(any_logic:TI (match_operand:TI 1 "nonimmediate_operand")
		      (match_operand:TI 2 "x86_64_general_operand")))]
  "TARGET_STV && TARGET_SSE2 && TARGET_64BIT"
  "ix86_expand_binary_operator (<CODE>, TImode, operands); DONE;")
...
(define_insn_and_split "*<code><mode>3_doubleword"
  ...
  "&& reload_completed"
  [(parallel [(set (match_dup 0)
		   (any_or:DWIH (match_dup 1) (match_dup 2)))
	      (clobber (reg:CC FLAGS_REG))])
   (parallel [(set (match_dup 3)
		   (any_or:DWIH (match_dup 4) (match_dup 5)))
	      (clobber (reg:CC FLAGS_REG))])]
  "split_double_mode (<MODE>mode, &operands[0], 3, &operands[0],
		      &operands[3]);")
...
(define_insn_and_split "*andn<mode>3_doubleword"
  [(set (match_operand:DWI 0 "register_operand" "=r,r")
	(and:DWI
	  (not:DWI (match_operand:DWI 1 "register_operand" "r,r"))
	  (match_operand:DWI 2 "nonimmediate_operand" "r,m")))
   (clobber (reg:CC FLAGS_REG))]
  "TARGET_BMI && TARGET_STV && TARGET_SSE"
  "#"
  "&& reload_completed"
  [(parallel [(set (match_dup 0)
